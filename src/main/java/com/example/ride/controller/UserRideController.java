...
import static com.example.ride.Request.RideDetailsRequest.NEAR_BY_RIDE_DETAILS;
...
public class UserRideController {
	...
	@Autowired
	private NearByRideService nearByRideService;
	...
	@PostMapping(NEAR_BY_RIDE_DETAILS)
	public GenericWebServiceResponse findNearByRides(@RequestBody NearByReideRequest request) {
		return nearByRideService.findNearbyRides(request);
	}
